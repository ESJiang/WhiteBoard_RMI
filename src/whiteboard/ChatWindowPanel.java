                ...
                gl_chatPanel.createParallelGroup(Alignment.TRAILING)
                        .addGroup(gl_chatPanel.createSequentialGroup()
                                .addGroup(gl_chatPanel.createParallelGroup(Alignment.TRAILING)
                                        .addComponent(activeUserLabel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 400,
                                                Short.MAX_VALUE)
                                        .addComponent(jListScroll, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 400,
                                                Short.MAX_VALUE)
                                        .addComponent(kickOut, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 400,
                                                Short.MAX_VALUE)
                                        .addComponent(chatLabel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 400,
                                                Short.MAX_VALUE)
                                        .addComponent(chatScrollPane, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 400,
                                                Short.MAX_VALUE)
                                        .addGroup(gl_chatPanel.createSequentialGroup()
                                                .addComponent(textingBox, GroupLayout.DEFAULT_SIZE, 313,
                                                        Short.MAX_VALUE)
                                                .addGap(1)
                                                .addComponent(sendButton, GroupLayout.PREFERRED_SIZE, 86,
                                                        GroupLayout.PREFERRED_SIZE)))
                                .addGap(0)));
        gl_chatPanel.setVerticalGroup(
                gl_chatPanel.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_chatPanel.createSequentialGroup()
                                .addComponent(activeUserLabel, GroupLayout.PREFERRED_SIZE, 25,
                                        GroupLayout.PREFERRED_SIZE)
                                .addGap(0)
                                ...
                                .addGroup(gl_chatPanel.createParallelGroup(Alignment.LEADING)
                                        .addComponent(textingBox, GroupLayout.PREFERRED_SIZE, 40,
                                                GroupLayout.PREFERRED_SIZE)
                                        .addComponent(sendButton, GroupLayout.PREFERRED_SIZE, 40,
                                                GroupLayout.PREFERRED_SIZE))
                                .addGap(0)));

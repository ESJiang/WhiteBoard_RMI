...
public class WhiteboardGUI extends JFrame {
    ...
    private static int stroke = 2, saved = 0, fontSize = 20, operationNum = 2;
    ...
    static Color color1 = Color.black, color2 = Color.white;
    static User user;
    ...
    private void init(User user, IServer server) {
        if (!user.isHost()) {
            ...
            switch (operationNum) {
                case 4:
                    try {
                        ...
                        Cursor eraserCursor = Toolkit.getDefaultToolkit().createCustomCursor(cursorImage,
                                new Point(15, 15),
                                "norm");
    ...
    private class MyMenu {
        ...
        private String strokes[] = {
                "/image/stroke1.png", "/image/stroke2.png", "/image/stroke3.png", "/image/stroke4.png"
        };
                ...
                public void actionPerformed(ActionEvent e) {
                    switch (saved) {
                        case 1:
                            ...
                            break;
                        case 0:
                            int confirmNew = JOptionPane.showConfirmDialog(null, "Do you want to save changes?",
                                    "New File",
                                    JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE);
                            if (confirmNew == 1) {
                                menu.newFile();
    ...
    private class MyToolbar {
        ...
        private String fontNameList[] = { "Arial", "Calibri", "Courier New", "Times New Roman", "Verdana",
                "Monospaced" };
    ...
    private static void updatePanelOnServer(Shape[] shapes, int index) {
        try {
    ...
    void sendMsg(String msg, String username) {
        try {
